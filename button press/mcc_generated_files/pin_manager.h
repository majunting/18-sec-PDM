...
#define analog1_TRIS               TRISAbits.TRISA0
#define analog1_LAT                LATAbits.LATA0
#define analog1_PORT               PORTAbits.RA0
#define analog1_ANS                ANCON0bits.ANSEL0
#define analog1_SetHigh()            do { LATAbits.LATA0 = 1; } while(0)
#define analog1_SetLow()             do { LATAbits.LATA0 = 0; } while(0)
#define analog1_Toggle()             do { LATAbits.LATA0 = ~LATAbits.LATA0; } while(0)
#define analog1_GetValue()           PORTAbits.RA0
#define analog1_SetDigitalInput()    do { TRISAbits.TRISA0 = 1; } while(0)
#define analog1_SetDigitalOutput()   do { TRISAbits.TRISA0 = 0; } while(0)
#define analog1_SetAnalogMode()  do { ANCON0bits.ANSEL0 = 1; } while(0)
#define analog1_SetDigitalMode() do { ANCON0bits.ANSEL0 = 0; } while(0)

// get/set analog2 aliases
#define analog2_TRIS               TRISAbits.TRISA1
#define analog2_LAT                LATAbits.LATA1
#define analog2_PORT               PORTAbits.RA1
#define analog2_ANS                ANCON0bits.ANSEL1
#define analog2_SetHigh()            do { LATAbits.LATA1 = 1; } while(0)
#define analog2_SetLow()             do { LATAbits.LATA1 = 0; } while(0)
#define analog2_Toggle()             do { LATAbits.LATA1 = ~LATAbits.LATA1; } while(0)
#define analog2_GetValue()           PORTAbits.RA1
#define analog2_SetDigitalInput()    do { TRISAbits.TRISA1 = 1; } while(0)
#define analog2_SetDigitalOutput()   do { TRISAbits.TRISA1 = 0; } while(0)
#define analog2_SetAnalogMode()  do { ANCON0bits.ANSEL1 = 1; } while(0)
#define analog2_SetDigitalMode() do { ANCON0bits.ANSEL1 = 0; } while(0)
